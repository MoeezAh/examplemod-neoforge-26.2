...
public class ModTradeSets {
    ...
    private static ResourceKey<TradeSet> create(final String id) {
        return ResourceKey.create(Registries.TRADE_SET, Identifier.fromNamespaceAndPath(ExampleMod.MOD_ID, id));
    }

    private static Holder.Reference<TradeSet> register(final BootstrapContext<TradeSet> context,
